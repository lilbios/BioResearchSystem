        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusExperiment = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicPicture = table.Column<byte[]>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpetimentId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Researches_Experiments_ExperimentId",
                        column: x => x.ExperimentId,
                        principalTable: "Experiments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Objectives_Researches_ResearchId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagResearch", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagResearch_Researches_ResearchId",
                        column: x => x.ResearchId,
                        principalTable: "Researches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TagResearch_Tag_TagId",
                        column: x => x.TagId,
                        principalTable: "Tag",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Objectives_ResearchId",
                table: "Objectives",
                column: "ResearchId");

            migrationBuilder.CreateIndex(
                name: "IX_Researches_ExperimentId",
                table: "Researches",
                column: "ExperimentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagResearch_ResearchId",
                table: "TagResearch",
                column: "ResearchId");

            migrationBuilder.CreateIndex(
                name: "IX_TagResearch_TagId",
                table: "TagResearch",
                column: "TagId");
